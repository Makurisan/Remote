...
#  define deflateBound          pdf_z_deflateBound
#  define deflatePrime          pdf_z_deflatePrime
...
#  define inflateCopy           pdf_z_inflateCopy
#  define inflateReset          pdf_z_inflateReset
#  define inflateBack           pdf_z_inflateBack
#  define inflateBackEnd        pdf_z_inflateBackEnd
#  define compress              pdf_z_compress
#  define compress2             pdf_z_compress2
#  define compressBound         pdf_z_compressBound
