...
const char CZipArchive::m_gszCopyright[] = {"The ZipArchive Library Copyright (c) 2000 - 2013 Artpol Software - Tadeusz Dracz"};
const char CZipArchive::m_gszVersion[] = {"4.5.0"};
...
bool CZipAddFilesEnumerator::Process(LPCTSTR lpszPath, const ZipArchiveLib::CFileInfo& info)
{
	...
	CZipAddNewFileInfo zanfi (lpszPath, m_pZip->GetRootPath().IsEmpty() != 0);
